...
public class HeapPage implements Page {
    ...
    */
    private int getNumTuples() {        
        ...
        int result=(int)Math.floor((BufferPool.PAGE_SIZE*8)/(tupleSize*8+1));
        return result;
    ...
    private int getHeaderSize() {        
        ...
        // some code goes here
        int result=(int)Math.ceil((double)getNumTuples()/(double)8);
        return result;         
    }
    ...
    public int getNumEmptySlots() {
        ...
        int result=0;
        int count=0;
hello:  for(int i=0;i<header.length;i++){
            for(int j=0;j<8;j++){
                if((header[i]&(1<<j))==0){
                    result++;
                }
